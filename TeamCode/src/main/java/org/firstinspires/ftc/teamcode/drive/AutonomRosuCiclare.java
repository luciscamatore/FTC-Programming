...
@Config
@Autonomous
public class AutonomRosuCiclare extends LinearOpMode {
    DcMotor intake;
    DcMotor intake2;
    DcMotor carusel;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(8.66, -64.370079, Math.toRadians(0));
        ...
        TrajectorySequence caruselTurnPark = drive.trajectorySequenceBuilder(startPose)
                //Hub
                .lineToConstantHeading(new Vector2d(-11,-48.03))
                .addTemporalMarker(()->{
                    rotateLeft();
                })
                .waitSeconds(0.7)
                ...
                .waitSeconds(0.7)
                //Bariera
                .lineToConstantHeading(new Vector2d(8.66, -64.370079))
                .strafeRight(3,
        ...
        Pose2d ciclarePose = new Pose2d(8.66, -63.97, Math.toRadians(0));
        TrajectorySequence ciclare = drive.trajectorySequenceBuilder(ciclarePose)
                ...
                .strafeTo(new Vector2d(28,-63.97),
                        SampleMecanumDrive.getVelocityConstraint(5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))

                .strafeTo(new Vector2d(17.55,-63.97),
                        SampleMecanumDrive.getVelocityConstraint(5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                ...
                .waitSeconds(0.7)
                .lineToConstantHeading(new Vector2d(8.66,-63.97))
                .forward(31)
                .build();

        cleste.setPosition(0.3);
//miclaus danis teo dinu
        waitForStart();
