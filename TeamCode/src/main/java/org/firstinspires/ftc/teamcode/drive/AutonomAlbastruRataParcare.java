...
@Config
@Autonomous
public class AutonomAlbastruRataParcare extends LinearOpMode {
    DcMotor intake;
    DcMotor intake2;
    DcMotor carusel;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence caruselTurnPark = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(0.1)
                //Hub x162.7 y82
               /* .lineToConstantHeading(new Vector2d(-43.10,24.62))
                ...
                .waitSeconds(1)
                //Plasare
                .strafeTo(new Vector2d(-33.55,24.62))
                .addTemporalMarker(() -> {
                    dropCube();
                })
                .waitSeconds(0.3)
                //Hub
                .strafeTo(new Vector2d(-43.10,24.62))
                .addTemporalMarker(() -> {
                    strangeBrat();
                })
                .waitSeconds(0.5)
