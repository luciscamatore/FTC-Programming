...
@Config
@Autonomous
public class AutonomRosuRataParcare extends LinearOpMode {
    DcMotor intake;
    DcMotor intake2;
    DcMotor carusel;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-32.3622, -64.370079, Math.toRadians(180));
        ...
        TrajectorySequence caruselTurnPark = drive.trajectorySequenceBuilder(startPose)
                //Carusel
                .lineToConstantHeading(new Vector2d(-57.08,-58.3))
                .addTemporalMarker(()->{
                ...
                .waitSeconds(0.1)
                //Hub
                .lineToConstantHeading(new Vector2d(-37.74,-25.2))
                ...
                .waitSeconds(1)
                //Plasare
                .strafeTo(new Vector2d(-29,-25.2))
                .addTemporalMarker(() -> {
                    dropCube();
                })
                .waitSeconds(0.3)
                //Hub
                .strafeTo(new Vector2d(-37.74,-25.2))
                .addTemporalMarker(() -> {
                    strangeBrat();
                })
                .waitSeconds(0.5)
                ...
                .waitSeconds(0.7)
                .lineToConstantHeading(new Vector2d(-59.60,-36),
